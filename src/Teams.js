...
function Teams() {
    ...
    if (isLoading) {
        ...
        return (
            <h1 className="text-light">Loading Teams...</h1>
        );
    }
    ...
    return (
        <div className="container-fluid text-center">
            ...
            <div className="row justify-content-center">
                <div className="card text-bg-dark col-10 col-sm-4 m-5">
            ...
            <div className="row justify-content-around">
                <div className="americanLeague card text-bg-dark col-10 col-sm-5 mb-5">
                    <div className="card-body">
                            ...
                            return (
                                <li className="list-group-item text-bg-dark">
                                    <Link to={`/team/${team.id}`} className="btn btn-dark w-100 p-3 m-0">
                                        <img src={`https://www.mlbstatic.com/team-logos/team-cap-on-dark/${team.id}.svg`} alt={`${team.name} logo`} title={`${team.name} logo`} />
                                        <br />
                                        {team.name}
                                    </Link>
                                </li>
                ...
                <div className="nationalLeague card text-bg-dark col-10 col-sm-5 mb-5">
                    <div className="card-body">
