...
function Game({ game }) {
    ...
    return (
        <div className="card col-10 col-sm-5 bg-dark text-light mt-5">
            <div id='gameTeamLogos' className='mt-3 mb-3'>
                <img src={`https://www.mlbstatic.com/team-logos/team-cap-on-dark/${game.gameData.teams.away.id}.svg`} alt={game.gameData.teams.away.name + ' logo'} title={game.gameData.teams.away.name + ' logo'} />
                ...
                <img src={`https://www.mlbstatic.com/team-logos/team-cap-on-dark/${game.gameData.teams.home.id}.svg`} alt={game.gameData.teams.home.name + ' logo'} title={game.gameData.teams.home.name + ' logo'} />
            </div>
